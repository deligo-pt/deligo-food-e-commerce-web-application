    ...
    <div className="min-h-screen bg-[#f6f6f7] dark:bg-neutral-950 transition-colors duration-200">
      <div className="mx-auto max-w-230 px-6 py-8 animate-pulse">
        ...
        <div className="mb-6 flex flex-wrap gap-3">
          {[1, 2, 3, 4].map((item) => (
            <div key={item} className="h-10 w-24 rounded-full bg-gray-200 dark:bg-neutral-800" />
          ))}
        </div>
        ...
        <div className="space-y-4">
          {[1, 2, 3, 4, 5].map((item) => (
            <div
              key={item}
              className="flex gap-4 rounded-xl border border-[#ededed] dark:border-neutral-800 bg-white dark:bg-neutral-900 p-5"
            >
              <div className="h-11 w-11 rounded-full bg-gray-200 dark:bg-neutral-800" />

              <div className="flex-1">
                <div className="flex items-start justify-between">
                  <div className="h-6 w-52 rounded bg-gray-200 dark:bg-neutral-800" />
                ...
                <div className="mt-4 h-6 w-20 rounded bg-gray-200 dark:bg-neutral-800" />

                <div className="mt-4 h-9 w-32 rounded bg-gray-200 dark:bg-neutral-800" />
              </div>
            </div>
          ))}
        </div>
