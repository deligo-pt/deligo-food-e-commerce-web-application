          ...
          <div className="flex w-full flex-col">
            ...
            <div className="mt-8 grid grid-cols-2 gap-6 border-b border-[#e3e3e3] dark:border-neutral-800 sm:mt-10">
              ...
              >
                <span
                  className={
                    mode === "mobile" ? "text-[#d7357c] dark:text-pink-400" : "text-[#707070] dark:text-neutral-400"
                  }
                >
                  {t("mobile")}
                </span>
                <span
                  className={[
                    ...
                    mode === "mobile"
                      ? "w-full bg-[#d7357c] dark:bg-pink-400"
                      : "w-0 bg-transparent",
                  ].join(" ")}
                />
              </button>
              ...
              >
                <span
                  className={
                    mode === "email" ? "text-[#d7357c] dark:text-pink-400" : "text-[#707070] dark:text-neutral-400"
                  }
                >
                  {t("email")}
                </span>
                ...
                {step === "credentials" ? (
                  mode === "mobile" ? (
                    <div className="flex items-center gap-3 sm:gap-4">
                      ...
                      >
                        ...
                        <ChevronDown
                          size={16}
                          strokeWidth={2.6}
                          className="text-[#767676] dark:text-neutral-500"
                        />
                      </button>
                      <div className="h-7 w-px bg-[#dedede] dark:bg-neutral-800" />
                      <div className="flex flex-1 items-center gap-3">
                        <Phone size={18} className="text-[#7d7d7d] dark:text-neutral-500" />
                        <input
                          type="tel"
                          inputMode="tel"
                          value={mobileNumber}
                    ...
                    <div className="flex items-center gap-3 px-1">
                      <Mail size={18} className="text-[#7d7d7d] dark:text-neutral-500" />
                      <input
                        type="email"
                        value={email}
                  ...
                  <div className="flex items-center gap-3 px-1">
                    <KeyRound size={18} className="text-[#7d7d7d] dark:text-neutral-500" />
                    <input
                      type="text"
                      inputMode="numeric"
                        ...
                        <button
                          ...
                          className={[
                            ...
                            selectedCountry.name === country.name
                              ? "bg-[#fff4f8] dark:bg-pink-950/20 text-[#d7357c] dark:text-pink-400"
                              : "text-[#2f2f2f] dark:text-neutral-300 hover:bg-[#fafafa] dark:hover:bg-neutral-800",
                          ].join(" ")}
                        >
                          ...
                          {selectedCountry.dialCode === country.dialCode &&
                          selectedCountry.name === country.name ? (
                            <Check size={18} className="text-[#d7357c] dark:text-pink-400" />
                          ) : null}
                        </button>
                      ))}
                    </div>
          ...
          <div className="w-full max-w-140 rounded-[28px] bg-white dark:bg-neutral-900 border border-transparent dark:border-neutral-800 p-6 shadow-[0_24px_80px_rgba(0,0,0,0.24)] dark:shadow-none sm:p-8">
            <div className="flex items-center justify-between gap-4">
              ...
              <button
                ...
                className="rounded-full p-1 text-[#2f2f2f] dark:text-neutral-400 transition-colors hover:bg-black/5 dark:hover:bg-neutral-850"
            ...
            <div className="space-y-4">
              <button
                ...
                className={[
                  ...
                  lang === "en"
                    ? "border-[#d7357c] dark:border-[#d7357c] bg-[#fff4f8] dark:bg-[#d7357c]/10"
              ...
              >
                ...
                {lang === "en" ? (
                  <Check size={28} className="text-[#d7357c] dark:text-pink-400" />
                ) : null}
              </button>
              <button
                type="button"
