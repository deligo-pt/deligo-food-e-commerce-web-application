    ...
    <div className="mx-auto max-w-2xl px-4 py-6 animate-pulse">
      ...
      <div className="space-y-4">
        {[1, 2, 3].map((item) => (
          <div
            key={item}
            className="flex items-start gap-4 rounded-xl border border-gray-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-4"
          >
            ...
            <div className="flex-1">
              ...
              <div className="h-3 w-64 rounded bg-gray-200 dark:bg-neutral-800" />
            </div>
        ...
        {/* Add Address Button */}
        <div className="h-24 rounded-xl border border-dashed border-gray-200 dark:border-neutral-800 bg-white dark:bg-neutral-900" />
      </div>
    </div>
  );
}
