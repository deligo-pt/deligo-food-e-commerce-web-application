export default function VouchersSkeleton() {
  return (
    <section className="w-full bg-[#f8f9fa] dark:bg-neutral-950 px-8 py-12 animate-pulse transition-colors duration-200 min-h-screen">
      {/* Header */}
      <div className="mb-10">
        <div className="mb-3 h-10 w-48 rounded bg-gray-200 dark:bg-neutral-800" />
        <div className="h-4 w-80 rounded bg-gray-200 dark:bg-neutral-800" />
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
        {[1, 2, 3, 4, 5, 6].map((item) => (
          <div
            key={item}
            className="rounded-xl border border-[#f3f4f5] dark:border-neutral-800 bg-white dark:bg-neutral-900 p-6"
          >
            <div className="mb-4 flex gap-4">
              <div className="h-12 w-12 rounded-full bg-gray-200 dark:bg-neutral-800" />

              <div className="flex-1">
                <div className="mb-2 h-5 w-32 rounded bg-gray-200 dark:bg-neutral-800" />
            ...
            <div className="mt-6 flex items-center justify-between">
              ...
              <div className="h-10 w-20 rounded-lg bg-gray-200 dark:bg-neutral-800" />
            </div>

            <div className="mt-4 border-t border-[#e7e8e9] dark:border-neutral-800 pt-4">
