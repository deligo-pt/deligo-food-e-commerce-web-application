const en = {
  ...
  home: "Home",
  settings: "Settings",
  loadingSponsorshipBanners: "Loading sponsorship banners...",
  ...
  noSponsorshipBannersAvailable: "No sponsorship banners available right now.",
  unableToLoadSponsorshipBanners: "Unable to load sponsorship banners.",
  ...
  loadMore: "Load more",
  noResultsHint: "Try a different word, or check the spelling.",
  sortLabel: "Sort",
  sortPriceLowToHigh: "Price: low to high",
  sortPriceHighToLow: "Price: high to low",
  sortRatingHighToLow: "Rating: high to low",
  allCuisines: "All",
  priceLabel: "Price",
  priceMin: "Min",
  priceMax: "Max",
  ...
  nearMeUnavailable:
    "Set a delivery address or allow location access to filter by distance.",
  inStockOnly: "In stock only",
  halalCertifiedRestaurants: "Halal-certified restaurants",
  clearFilters: "Clear filters",
  useMyLocation: "Use my location",
  locationDenied: "Location access was denied.",
  failedToOpenItem: "Could not open this item. Please try again.",
  prefixMatchHint:
    "Search matches the start of a word — “izza” will not find “Pizza”.",
