const pt = {
  ...
  loadingSponsorshipBanners: "Carregando banners de patrocínio...",
  authTokenMissing:
    "O token de autenticação está ausente. Faça login novamente.",
  browseLatestSponsorshipBanners:
    "Explore os banners de patrocínio mais recentes da API.",
  noSponsorshipBannersAvailable:
    "Nenhum banner de patrocínio disponível no momento.",
  unableToLoadSponsorshipBanners:
    "Não foi possível carregar os banners de patrocínio.",
  ...
  needHelpWithOrder: "Precisa de ajuda com seu pedido?",
  ...
  rateStars: "Avaliar {count} em 5",
  reviewPlaceholder: "Adicione uma nota (opcional)",
  productReviewLabel: "Avaliação de {product}",
  deliveryReviewLabel: "Avaliação do estafeta",
  rateEveryItem:
    "Avalie todos os artigos, ou deixe-os todos em branco e avalie o estafeta.",
  productsAlreadyRated: "Já avaliou os artigos deste pedido.",
  deliveryAlreadyRated: "Já avaliou o estafeta deste pedido.",
  failedToSubmitRating: "Não foi possível enviar a avaliação. Tente novamente.",
  thankYou: "Obrigado!",
